...
Early development. See [GitHub Issues](https://github.com/justminime/faces-h/issues) for current work.

| Milestone | Status |
|-----------|--------|
| M1 — Foundation (repo, CI/CD, sidecar, DB, scanner, FAISS, Tauri shell, React scaffold) | 🔲 In progress |
| M2 — Core ML (face detection, clustering, uncertain queue) | 🔲 Planned |
| M4 — Search (multi-person AND, date filter) | 🔲 Planned |
| M5 — Corrections (mark wrong, re-evaluation pipeline) | 🔲 Planned |
| M6 — Ship (onboarding, installer, 5TB validation) | 🔲 Planned |
